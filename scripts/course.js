...
cseCourse.addEventListener("click", () => {
    const cSE = courses.filter(course => course.subject.toLowerCase() === "cse")
    courseList.innerHTML = "";
    displayCourse(cSE);
})

wddCourse.addEventListener("click", () => {
    const wDD = courses.filter(course => course.subject.toLowerCase() === "wdd")
    courseList.innerHTML = "";
    displayCourse(wDD);
})
...
function displayCourse(courses) {
    ...
    courses.forEach(course => {
        ...
        if (course.completed) {
            courseName.className = "completed-course-name";
        }
        else {
            courseName.className = "incompleted-course-name";
        }
        courseName.innerHTML = `${subject} ${number}`;
